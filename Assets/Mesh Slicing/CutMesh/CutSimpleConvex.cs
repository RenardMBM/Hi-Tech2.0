...
public class CutSimpleConvex : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        //topPart.GetComponent<Rigidbody>().AddForce(0, 2000, 0);
        //bottomPart.GetComponent<Rigidbody>().AddForce(0, 2000, 0);
        if(other.gameObject.tag == "cut")
        {
            obj.GetComponent<Counter>().count += 1;
        }
    ...
    void CutMesh() {
        ...
        //topPart.AddComponent<BoxCollider>();
        // topPart.AddComponent<Rigidbody>();
        bottomPart = Instantiate(prefabPart);
        // bottomPart.AddComponent<BoxCollider>();
        //  bottomPart.AddComponent<Rigidbody>();
        topPart.tag = "Destroy";
        bottomPart.tag = "Destroy";
        StartCoroutine(Rig());
    ...
    public IEnumerator Rig()
    {
        ...
        topPart.AddComponent<MeshCollider>();
        topPart.GetComponent<MeshCollider>().convex = true;
        topPart.AddComponent<Rigidbody>();
        //bottomPart.AddComponent<MeshCollider>();
        bottomPart.AddComponent<MeshCollider>();
        bottomPart.GetComponent<MeshCollider>().convex = true;
        bottomPart.AddComponent<Rigidbody>();
